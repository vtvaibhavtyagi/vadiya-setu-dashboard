...
// material-ui
import { Box, Card, Grid, Typography, TextField, Button, InputAdornment, List, ListItem, ListItemText, IconButton, Tooltip, Avatar, Divider, Dialog } from '@mui/material';
...
const UIColor = () => {
  ...
  const DialogVaidya = (item, index) => {
    ...
    return (
      ...
      >
        ...
        <DialogContent>
          <Box sx={{ display: "flex", flexDirection: "column", justifyContent: "space-between", marginBlock: 2 }}>
            <Typography variant="h3" component="div">
              Name
            </Typography>
            <Typography variant="body1" sx={{ fontSize: "1em", marginBlock: 1 }} component="div">
              {item.name}
            </Typography>
            <Typography variant="h3" component="div">
              Desc
            ...
            <Typography>
              <div dangerouslySetInnerHTML={{ __html: getwysiwygToHtml(item.diagonis) }} />
            </Typography>
            <Typography variant="h3" component="div">
              Treatment
            </Typography>
            <Typography>
              <div dangerouslySetInnerHTML={{ __html: getwysiwygToHtml(item.treatMent) }} />
            </Typography>
          </Box>
        </DialogContent>
        <DialogActions>
              ...
              <Box>
                <IconButton>
                  <ArrowForwardIosIcon onClick={() => {
                    ...
                    patientRecordCnt[i] = patientRecordCnt[i] == true ? false : true
  ...
  useEffect(() => {
    async function getRecord() {
      ...
      //   }
      // })
      let response = { "status": "success", "patientData": { "status": "success", "patient": { "address": "mumbai, maharashatra", "district": "mumbai", "docType": "patient", "email": "rohit@gmail.com", "name": "Rohit", "password": "$2b$10$3Ex6Yn/jtxHprQSRhpXZWecf/buZNEp/zM7cRUdgvdE93mXv4gw82", "phone": 1234567890, "pid": "PYm3D-Q4kf", "state": "maharashatra" }, "record": [{ "createTime": "12/01/2021", "desc": "nk", "diagonis": { "blocks": [{ "data": {}, "depth": 0, "entityRanges": [], "inlineStyleRanges": [], "key": "8lq8s", "text": "hv", "type": "unstyled" }], "entityMap": {} }, "diagonisReport": ["bafybeia765lw3sjmrgdwlvcplwo2gcsvg7x7ouwm6zveh2mn2237hgeahi"], "did": "DRmO3zk1Lv", "docType": "record", "drugsName": null, "drugsReport": [], "name": "jhj", "pid": "PYm3D-Q4kf", "rid": "R4eW0_xmMi", "treatMent": null, "treatmentReport": [] }, { "createTime": "12/01/2021", "desc": "uiguiy", "diagonis": { "blocks": [{ "data": {}, "depth": 0, "entityRanges": [], "inlineStyleRanges": [], "key": "aohu8", "text": "kljh", "type": "unstyled" }], "entityMap": {} }, "diagonisReport": ["bafybeia765lw3sjmrgdwlvcplwo2gcsvg7x7ouwm6zveh2mn2237hgeahi"], "did": "DRmO3zk1Lv", "docType": "record", "drugsName": null, "drugsReport": [], "name": "mal", "pid": "PYm3D-Q4kf", "rid": "RWUQEZkXCD", "treatMent": null, "treatmentReport": [] }] } }
        ...
        <Grid container spacing={4}>
          <Grid item xs={4}>
            <Box sx={{ display: "flex", flexDirection: "row" }}>
              <Avatar sx={{ width: 56, height: 56, marginInline: 2 }} alt="Remy Sharp" src="assets/images/user.png" />
              <Box>
            ...
            <Box sx={{ width: '100%' }}>
              ...
              <TabPanel value={value} index={0}>
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={6} >
                    <Box sx={{ border: "1.5px solid rgba(0, 0, 0, .125)", p: 2 }} >
